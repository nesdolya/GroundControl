...
class JobInfo:
    """
    A class used to manage SchedulerSS jobs information

    Attributes:
        job_class (function path): schedulerss.jobs.SoundSpaceJob.SoundSpaceJob (do not change)
    ...
    def __init__(self,job_name='',funct_path='',funct_name='',funct_args='',minute='*',hour='*',month='*',day='*',day_of_week='*',cron_time=[],job_id=None):
        self._job_class = 'schedulerss.jobs.SoundSpaceJob.SoundSpaceJob'
