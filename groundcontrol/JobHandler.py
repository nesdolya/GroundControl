...
import requests, os
from groundcontrol import Server_Manager as ss
logger = logging.getLogger(__name__)

class JobHandler:
    """
    The JobHandler implements REST API for adding and manipulating jobs. It requires GroundControl.Server_Manager to be running to get the HTTP_PORT being used.

    Attributes:
        job_url (URL): the URL used to access the GroundControl server
